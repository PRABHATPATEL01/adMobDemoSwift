...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/LRPreferenceLinkSDK/LRPreferenceLinkSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/LRPrivacyManagerSDK/LRPrivacyManagerSDK.framework"
fi
